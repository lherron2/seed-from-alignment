...
\addplot+ [boxplot prepared={draw position=1, lower whisker=0.0000, lower quartile=0.3858, median=0.7060, upper quartile=0.9396, upper whisker=0.9655}, draw=c_rn_rs, fill=c_rn_rs, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=2, lower whisker=0.0000, lower quartile=0.3883, median=0.7022, upper quartile=0.9516, upper whisker=0.9796}, draw=c_rn_lf, fill=c_rn_lf, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=3, lower whisker=0.0000, lower quartile=0.3883, median=0.7022, upper quartile=0.8721, upper whisker=0.9796}, draw=c_rn_ef, fill=c_rn_ef, fill opacity=0.20, very thick] coordinates {};
...
\addplot+ [boxplot prepared={draw position=1, lower whisker=0.0976, lower quartile=0.4576, median=0.7643, upper quartile=0.9096, upper whisker=0.9722}, draw=c_rn_rs, fill=c_rn_rs, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=2, lower whisker=0.0976, lower quartile=0.4479, median=0.7643, upper quartile=0.8788, upper whisker=0.9722}, draw=c_rn_lf, fill=c_rn_lf, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=3, lower whisker=0.1000, lower quartile=0.4479, median=0.7154, upper quartile=0.9021, upper whisker=0.9722}, draw=c_rn_ef, fill=c_rn_ef, fill opacity=0.20, very thick] coordinates {};
...
\addplot+ [boxplot prepared={draw position=1, lower whisker=0.0000, lower quartile=0.4733, median=0.5216, upper quartile=0.6265, upper whisker=0.9167}, draw=c_rn_rs, fill=c_rn_rs, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=2, lower whisker=0.0000, lower quartile=0.2675, median=0.4098, upper quartile=0.5847, upper whisker=0.8776}, draw=c_rn_lf, fill=c_rn_lf, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=3, lower whisker=0.1096, lower quartile=0.4337, median=0.5447, upper quartile=0.6649, upper whisker=0.8776}, draw=c_rn_ef, fill=c_rn_ef, fill opacity=0.20, very thick] coordinates {};
...
\addplot+ [boxplot prepared={draw position=1, lower whisker=0.1240, lower quartile=0.2955, median=0.3540, upper quartile=0.4058, upper whisker=0.4912}, draw=c_rn_rs, fill=c_rn_rs, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=2, lower whisker=0.1550, lower quartile=0.2921, median=0.3333, upper quartile=0.3836, upper whisker=0.5574}, draw=c_rn_lf, fill=c_rn_lf, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=3, lower whisker=0.1231, lower quartile=0.2889, median=0.3918, upper quartile=0.5319, upper whisker=0.6261}, draw=c_rn_ef, fill=c_rn_ef, fill opacity=0.20, very thick] coordinates {};
...
\addplot+ [boxplot prepared={draw position=1, lower whisker=0.1649, lower quartile=0.2847, median=0.3765, upper quartile=0.4583, upper whisker=0.5638}, draw=c_rn_rs, fill=c_rn_rs, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=2, lower whisker=0.0438, lower quartile=0.1290, median=0.3743, upper quartile=0.4426, upper whisker=0.7347}, draw=c_rn_lf, fill=c_rn_lf, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=3, lower whisker=0.2062, lower quartile=0.3354, median=0.4252, upper quartile=0.6489, upper whisker=0.8451}, draw=c_rn_ef, fill=c_rn_ef, fill opacity=0.20, very thick] coordinates {};
...
\addplot+ [boxplot prepared={draw position=1, lower whisker=0.3195, lower quartile=0.3696, median=0.4197, upper quartile=0.4697, upper whisker=0.5198}, draw=c_rn_rs, fill=c_rn_rs, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=2, lower whisker=0.4167, lower quartile=0.4554, median=0.4940, upper quartile=0.5327, upper whisker=0.5714}, draw=c_rn_lf, fill=c_rn_lf, fill opacity=0.20, very thick] coordinates {};
\addplot+ [boxplot prepared={draw position=3, lower whisker=0.4881, lower quartile=0.4938, median=0.4995, upper quartile=0.5052, upper whisker=0.5109}, draw=c_rn_ef, fill=c_rn_ef, fill opacity=0.20, very thick] coordinates {};
